...
<template>
  <main>
    ...
    <div class="container">
      <h1>
        <img width="279" height="86" src="/src/assets/images/images-and-videos/logos/LUMINA-logo.svg" alt="Logotyp för Lumina">
      </h1>

      <div class="btn-container">
        <router-link to="/menu">
          <button class="menu">Meny</button>
        </router-link>
        <router-link to="/book">
...
<style scoped>
  @import 'SectionOneVideoStyle.scss';
</style>
